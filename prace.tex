...
\def\KlicovaSlova{%
{RDF} {znalostní graf} {propojená data} {vizualizace} {webová aplikace}
}
\def\KlicovaSlovaEN{%
{RDF} {knowledge graph} {linked data} {visualization} {web application}
}
...
\include{chapter-uvod}
\include{chapter-technicke-predpoklady}
\include{chapter-analyza}
\include{chapter-navrh}
\include{chapter-implementace}
\include{chapter-testovani}
\include{chapter-zaver}
...
\appendix
\chapter{Přílohy}
\input{appendix-general}
\include{appendix-screenshots}
