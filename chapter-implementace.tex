...
Aplikaci lze přeložit přidáním souboru \texttt{<jazykový-kód>.yaml} do adresáře \texttt{./locales}. Soubor vytvořte jako kopii souboru \texttt{en.yaml}, jež obsahuje anglické překlady aplikace. Aplikaci pak stačí znova přeložit a vytvořený jazyk bude v aplikaci dostupný.
